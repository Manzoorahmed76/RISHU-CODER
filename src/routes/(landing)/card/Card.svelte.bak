      ...
      <Window bind:overlay bind:anim_init >
        ...
        <div class="flex-middle h-auto gap-2 mt-6
          ...
          <div class="flex-middle flex-col gap-5 ms-10 text-center
                      ...
                      max-sm:text-justify">
              <!-- First Line -->
              <LinedTitle title="Mr.BaBlU"/>
              <!-- Introduction -->
              <div class="mx-[1rem]">
                <p1>
                  Hello! I am Mr.BaBlU, and iam graphics designer, web developer, gfx designer.
                ...
                <div class="flex-middle gap-4 pt-5 max-sm:flex-col max-sm:items-start">
                  ...
                  <i class="fa-solid fa-gamepad text-[--theme-purple] flex flow-row gap-2"><p2>Game Developer</p2></i>
                  <i class="fa-solid fa-globe text-[--theme-blue] flex flow-row gap-2"><p2>Web Developer</p2></i>
                </div>
              </div>
              <!-- Second Line -->
              <LinedTitle/>
